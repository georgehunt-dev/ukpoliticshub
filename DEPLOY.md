...
**The daily briefing is dated.** `data/briefing.ts` is stamped 14 August 2026 and does not move on its own. It will drift out of step with the live news within a day or two. Either refresh it on a schedule or mark it clearly as a dated edition.
